...
void kea_sc_WifiS_init()
{
    kea_sc_ConfigS_ParamStatus ssidParamStatus = kea_sc_ConfigS_getNetworkSSID(ssid, STA_SSID_MAX_LENGTH);
    kea_sc_ConfigS_ParamStatus passwordParamStatus = kea_sc_ConfigS_getNetworkPassword(password, STA_PASSWORD_MAX_LENGTH);

    wifi_mode_t mode;
    if (ssidParamStatus == kea_sc_ConfigS_ParamStatus_ERROR ||
        ssidParamStatus == kea_sc_ConfigS_ParamStatus_EMPTY ||
        passwordParamStatus == kea_sc_ConfigS_ParamStatus_ERROR)
    {
        mode = WIFI_MODE_AP;
    } else {
